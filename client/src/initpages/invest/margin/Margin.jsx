  ...
  return (
    <div className="">
        ...
        <div className="absolute top-0 bg-cover flex flex-col mt-10 sm:mt-0 sm:flex-row justify-between gap-8    left-0 right-0 bg-gradient-to-tr from-black to-[#000E43]">
          <div className="invest  sm:w-1/2 flex flex-col justify-center mt-10 px-8">
            ...
            <span className="text-lg leading-5 sm:text-xl tracking-wider text-white py-6">
              Increase your buying power on Public with some of the industry’s
              lowest margin rates and more transparency at every step.
            </span>
          ...
          <div className="relative invest-image sm:w-1/2 mt-20 ">
            <img src={illus} alt="" className="sm:w-4/6 h-full mx-auto" />
            <div className="hidden sm:block absolute text-icon top-10 left-98">
              ----- Buying power with margin
            </div>
            <div className="hidden sm:block absolute text-white top-80 left-98">
      ...
      <div className="container-all">
        {/* leading texts */}
        <div className="grid grid-cols-1 sm:grid-cols-2 py-20 gap-2 my-10 sm:my-20">
          <div className="sm:w-5/6 sm:mx-auto">
            <p className=" text-4xl sm:text-6xl text-black">
              More buying power. Lower rates.
            </p>
            <span className="block py-2">
              When you enable margin on Public, you can amplify your investment
              potential with access to some of the lowest borrowing rates among
              US brokerages.
            </span>
          </div>
          <div className="sm:w-5/6 sm:mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 py-20 gap-4 my-10 sm:my-20 bg-gradient-to-br from-black to-[#000E43]">
          ...
          <div className="px-4 sm:w-5/6 mx-auto text-text">
            ...
            <span className="block pt-8 text-sm text-white">
              For margin balances above $1,000,000, email concierge@public.com
...
Margin investing on Public enables you to increase your buying power by leveraging the stocks and bonds in your portfolio as collateral for a loan. When you invest on margin, you can capitalize on market opportunities and acquire more assets than with cash alone, potentially amplifying your gains."
              ...
              />
              <Accordion
                question="How do margin interest rates work on Public?
"
                answer="
...
To qualify for margin investing on Public, we consider several factors, including your trade history and brokerage account balance. It only takes a few minutes to apply."
              ...
              />
              <Accordion
                question="How do I get started with margin investing on Public?
"
                answer="
