        ...
        <div className="flex flex-col mt-10 sm:mt-0 sm:flex-row justify-between gap-8 container-all">
          <div className="invest  sm:w-1/2 flex flex-col justify-center">
            ...
            <span className="text-lg leading-5 sm:text-xl tracking-wider">
              On Public, you can open Traditional and Roth IRAs and plan for
          ...
          <div className="invest  sm:w-1/2 flex flex-col justify-center">
            <div>
              <Accordion
                ...
                answer="With a self-directed IRA on Public, you can access thousands of stocks, ETFs, and bonds to align your investing style with your retirement goals."
                id={1}
              />
            </div>
            <div>
...
Prefer to set it and forget it? You can schedule recurring contributions to a pre-made Investment Plan—or build your own with up to 20 assets."
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 py-20 gap-4 my-10 sm:my-20 items-center">
        <div className="sm:w-4/5 sm:mx-auto">
          ...
          <span className="text-lg sm:text-2xl">
            If you roll over a 401(k) or transfer an IRA to Public, you can earn
            a bonus of up to $10,000. We'll even cover any fees from your old
            brokerage.*
          </span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 py-20 gap-4 my-10 sm:my-20 items-center">
        <div className="sm:w-4/5 sm:mx-auto">
          ...
          <span className="text-lg sm:text-2xl">
            With an IRA on Public, you can set up recurring investments that
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 py-20 gap-4 my-10 sm:my-20 items-center justify-center bg-slate-50">
