    ...
    <div>
      ...
      <div className="header bg-black p-8 rounded-t-lg">
        ...
        <div className="w-[90%] mx-auto flex flex-col md:flex-row justify-between items-center my-16 gap-4">
          <div className="leading  md:w-2/3">
            ...
            <span className="text-white font-bold text-lg">
              On Public, you can earn a rebate of $0.06–$0.18 on stock and ETF
              option contracts, based on your monthly trading volume, with no
              commissions or per-contract fees.
            </span>
      ...
      <div className="header bg-black p-8 rounded-b-lg">
        ...
        <div className="my-5 flex flex-col gap-6 text-sm text-center sm:w-4/5 mx-auto">
          <span>
            ...
            contract. See terms & conditions for enrolling in Public's options
            rebates at public.com/disclosures/rebate-terms
          </span>
        </div>
        {/* informed */}
        <div className="mt-20 mb-5 text-center sm:w-4/5 sm:mx-auto">
      ...
      {/* section */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 my-4 py-4 sm:py-10 sm:border-t-1 sm:border-b-1 border-slate-200">
        <div className="">
