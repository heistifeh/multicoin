...
import project00 from "../../assets/images/project-00.png";
import Navbar from "../../components/Navbar";
const Features = () => {
  return (
    // <div className="my-20 max-w-[1420px] mx-auto">
    
    //   <div className="leading text-center text-3xl md:text-5xl">
    ...
    //       <p className="text-black text-3xl py-4 ">Queue</p>
    //       <span className="w-2/3 mx-auto">
    ...
    //         updates.
    //       </span>
    //       <div className="learn-more flex items-center justify-center text-primary  gap-2 p-4 hover:underline-offset-1">
    //         <span>Learn more</span>
    //         <FaArrowRight />
    //       </div>
    //       <div className="img mb-8">
    ...
    //       </div>
    //       <div className="img mb-8">
    //         <img src={project0} alt="" className="w-1/2 mx-auto" />
    //       </div>
    //     </div>
    //     <div className="key-moments text-center flex flex-col  hover:translate-y-2 duration-300 bg-slate-100 ">
    //       <p className="text-black text-2xl md:3xl mt-8 md:mt-0  pt-4">
    ...
    //       </div>
    //       <div className="img mb-8">
    //         <img src={project00} alt="" className="w-1/2 mx-auto" />
    //       </div>
    //     </div>
    //   </div>
    ...
    //     <p className="text-black text-4xl md:text-4xl">And up to $250,000</p>
    //     <p className="text-2xl md:text-4xl">in instant buying power</p>
